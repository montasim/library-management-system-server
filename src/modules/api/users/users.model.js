        ...
        company: {
            ...
            address: {
                country: {
                    ...
                    trim: true,
                    description:
                        'The country where the company resides. This field stores the name of the country as a string.',
                },
                state: {
                    type: String,
                    trim: true,
                    description:
                        'The state or region within the country where the company is located. This field is used to store the state or regional name.',
                },
                city: {
                    type: String,
                    trim: true,
                    description:
                        'The city or locality within the state where the company lives. This field captures the city name.',
                },
            },
            website: {
                type: String,
