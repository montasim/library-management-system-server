...
const adminActivityLoggerSchema = new mongoose.Schema(
    {
        ...
        action: {
            ...
            description: 'Type of action performed. Must be one of the predefined actions.',
        },
        description: {
            type: String,
        ...
        affectedId: {
            type: Schema.Types.ObjectId,
            description: 'ID of the entity affected by the action, if applicable.',
        },
    },
    {
        timestamps: { createdAt: true, updatedAt: false },
        versionKey: false,
        description: 'Schema for logging administrative activities, including user actions and system events.',
    }
);

const AdminActivityLoggerModel = mongoose.model('AdminActivityLogger', adminActivityLoggerSchema);
