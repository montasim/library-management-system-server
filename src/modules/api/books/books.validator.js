...
const createBook = validateWithSchema([
    {
        schema: booksSchema.createBookSchema, property: 'body'
    }
]);

const getBooks = validateWithSchema([
    {
        schema: booksSchema.getBooksQuerySchema, property: 'query'
    }
]);

const getBook = validateWithSchema([
    {
        schema: booksSchema.bookIdParamSchema, property: 'params'
    }
]);

const updateBook = validateWithSchema([
    {
        schema: booksSchema.updateBookSchema, property: 'body'
    }
]);

const deleteBooks = validateWithSchema([
    {
        schema: booksSchema.bookIdsParamSchema, property: 'query'
    }
]);
