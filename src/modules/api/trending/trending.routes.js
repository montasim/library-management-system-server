...
import trendingSubjectsRoutes
    from './trendingSubjects/trendingSubjects.routes.js';
...
router.use(`/${routesConstants.trendingSubjects.routes}`, trendingSubjectsRoutes);
